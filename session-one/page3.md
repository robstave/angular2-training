...
When we created the app with angular-cli, it created a root app.  The file that defines this is app.module.ts
...
the source code for something like [http.module.ts source](https://github.com/angular/angular/blob/master/modules/%40angular/http/src/http.ts)
...
The exported class AppComponent is basically what was the controller in angular1.x.  
